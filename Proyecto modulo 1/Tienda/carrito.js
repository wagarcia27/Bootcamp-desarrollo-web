...
var shoppingCartItemsContainer = document.querySelector(
    '.shoppingCartItemsContainer'
  );
function addToCartClicked(event) {
    var button = event.target;
    var item = button.closest('.product');
  
    var itemTitle = item.querySelector('.product__title').textContent;
    var itemPrice = item.querySelector('.item-price').textContent;
    var itemImage = item.querySelector('.product__img').src;
...
const mostrar_alerta = document.querySelector(".my-alert")
